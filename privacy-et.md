...
Kui kasutad "Lisa Meeldetuletustesse" funktsiooni, lisatakse action item'id sinu Apple Meeldetuletustesse Loendi nimega "Koosolek".

## Kasutaja õigused

Sul on alati õigus:

- **Vaadata** kõiki sinu andmeid äpis
- **Kustutada** üksikuid koosolekuid või kõiki korraga
...
Koosolek pole mõeldud alla 13-aastastele kasutajatele.
...
- **App'i arendaja**: OÜ Vertex Investment, Eesti
